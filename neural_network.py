...
#Creates tensorboard
tensorboard = TensorBoard(log_dir='./logs/tensorboard/regression' + date, histogram_freq=0, write_graph=True, write_images=True)
...
if save_csv.lower() is 'y' or 'yes':
    frame.to_csv('./predictions/%s_miseq_predictions' % date, index=False)
